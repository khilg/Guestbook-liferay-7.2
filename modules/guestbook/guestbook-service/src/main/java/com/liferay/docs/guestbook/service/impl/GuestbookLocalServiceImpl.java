...
public class GuestbookLocalServiceImpl extends GuestbookLocalServiceBaseImpl {
	...
	public Guestbook addGuestbook(long userId, String name,
		...
		//Registering permission for Adding GuestBook
		resourceLocalService.addResources(user.getCompanyId(), groupId, userId,
			    Guestbook.class.getName(), guestbookId, false, true, true);
		
		//Adding the GuestBook as an asset
		...
		//Adding Releated Asset from the GuestBook as an asset
	...
	public Guestbook updateGuestbook(long userId, long guestbookId,
		    String name, ServiceContext serviceContext) throws PortalException,
		        ...
		        //Registering Update permission in GuestBook
		        resourceLocalService.updateResources(serviceContext.getCompanyId(),
		        	    serviceContext.getScopeGroupId(), 
		        	    Guestbook.class.getName(), guestbookId,
		        	    serviceContext.getModelPermissions());
		        
		      //Updating the GuestBook as an asset
		      ...
		      //Updating Releated Asset from the GuestBook as an asset
    ...
    //Registering Individual Permission for deleteing GuestBook
    resourceLocalService.deleteResource(serviceContext.getCompanyId(),
    	    Guestbook.class.getName(), ResourceConstants.SCOPE_INDIVIDUAL,
    	    guestbookId);
    
  //Deleting the GuestBook as an asset
    AssetEntry assetEntry = assetEntryLocalService.fetchEntry(
            Guestbook.class.getName(), guestbookId);

	assetLinkLocalService.deleteLinks(assetEntry.getEntryId());
	
	//Deleting Releated Asset from the GuestBook as an asset
